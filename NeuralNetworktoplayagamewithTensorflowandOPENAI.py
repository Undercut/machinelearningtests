...
for each_game in range(10):
    ...
    for _ in range(goal_steps):
        ...
        if len(prev_obs)==0:
            ...
            #print('modelpredict: ',model.predict(prev_obs.reshape(-1,len(prev_obs),1)))

            #print('the first  predict one : ',model.predict(prev_obs.reshape(-1,len(prev_obs),1))[0])
            #you may confused about whay add a [0],actually ,predict()method returns a list
            # print it out and you figure it out
